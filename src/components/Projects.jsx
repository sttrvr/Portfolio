...
const projects = [
  {
    ...
    tag: 'Veb Ilova',
    desc: 'To\'lov tizimi va mahsulot boshqaruvi bilan zamonaviy onlayn do\'kon. Stripe integratsiyasi va real-time yangilanishlar bilan.',
    link: '#',
  ...
  },
  {
    ...
    desc: 'Katta hajmdagi ma\'lumotlarni tahlil qilish va sun\'iy intellekt modelini o\'qitish platformasi. GPT-4o modeli bilan quvvatlanadigan zamonaviy chat interfeysi.',
    link: '/lumaai',
  ...
  },
  {
    ...
    tag: 'Dizayn Tizimi',
    desc: 'Minimal dizayn va interaktiv elementlarga ega shaxsiy veb-sayt. Framer Motion va Tailwind CSS bilan yaratilgan.',
    link: '#',
  ...
  },
  {
    ...
    desc: 'Real vaqtda yangilanuvchi vazifalar va jamoa hamkorligi ilovasi. Socket.io va MongoDB bilan quvvatlanadigan.',
    link: '#',
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Zamonaviy texnologiyalar va eng yaxshi amaliyotlar yordamida yaratilgan loyihalar
          </p>
        </motion.div>
        ...
        >
          <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">
            Loyiha ustida ishlashga tayyormisiz?
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-xl mx-auto">
            Keling, sizning g'oyangizni hayotga tatbiq etaylik va ajoyib mahsulot yarataylik
          </p>
